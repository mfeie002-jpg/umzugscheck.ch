    ...
    return (
      <Card className="bg-success/5 border-success/20">
        <CardContent className="p-6 text-center">
          ...
          <p className="text-sm text-muted-foreground">Sie erhalten bald unsere Berner Umzugstipps</p>
        </CardContent>
      </Card>
    );
  }
    ...
    <Card className="bg-gradient-to-br from-primary/5 to-accent/5 border-primary/20">
      <CardContent className="p-6">
        <div className="flex items-center gap-2 mb-4">
          ...
          <div>
            <h3 className="font-semibold">Berner Umzugstipps</h3>
        ...
        <form onSubmit={handleSubscribe} className="space-y-3">
          <Input type="email" placeholder="ihre@email.ch" value={email} onChange={e => setEmail(e.target.value)} required className="bg-background" />
