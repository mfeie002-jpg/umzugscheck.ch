...
export const BernWeatherWidget = () => {
  ...
  const [forecast] = useState([
    { day: "Mo", temp: 10, condition: "sunny" },
    { day: "Di", temp: 9, condition: "cloudy" },
    { day: "Mi", temp: 7, condition: "rainy" },
    { day: "Do", temp: 8, condition: "cloudy" },
    { day: "Fr", temp: 11, condition: "sunny" },
  ]);
    ...
    <Card className="border-2 border-primary/10">
      <CardContent className="p-6">
        <div className="flex items-center justify-between mb-4">
          <div>
            <h3 className="font-semibold text-lg">Wetter Bern</h3>
