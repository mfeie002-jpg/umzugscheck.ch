...
export const USPSection = memo(function USPSection() {
  return (
      ...
      <div className="container relative">
        ...
        <RevealOnScroll direction="up" className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold tracking-tight mb-4">
            Warum <ShinyText>Umzugscheck.ch</ShinyText>?
          </h2>
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            Die führende Schweizer Plattform für Umzugsvergleiche.
          </p>
          <AnimatedDivider variant="gradient" className="mt-6 max-w-md mx-auto" />
        </RevealOnScroll>
          ...
          {usps.map((usp, index) => (
            ...
            >
              <MagneticButton strength={0.15} className="w-full h-full">
                ...
                >
                  {/* Border Beam for highlighted card */}
                  {usp.highlight && <BorderBeam size={100} duration={12} />}
