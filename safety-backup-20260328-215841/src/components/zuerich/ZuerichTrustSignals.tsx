...
const signals = [
  ...
  { icon: Users, label: "28'000+ Kunden", description: "Zufriedene Nutzer" },
  { icon: Star, label: "4.8/5 Sterne", description: "Durchschnittsbewertung" },
];

export const ZuerichTrustSignals = () => {
  return (
