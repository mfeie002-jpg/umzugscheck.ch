...
const HomepageClassic = lazy(() => import("./pages/HomepageClassic"));
const HomepageV1 = lazy(() => import("./pages/HomepageV1"));
...
const ProofEngine = lazy(() => import("./pages/ProofEngine"));
...
// RegionenOverview removed - now redirects to /umzugsfirmen-schweiz
import { RegionSlugRedirect } from "./components/redirects/RegionRedirect";
...
const PostMoveSurveyPage = lazy(() => import("./pages/PostMoveSurveyPage"));
...
const AdminTaskQueue = lazy(() => import("./pages/admin/TaskQueue"));
...
const AfterMoveCareDemo = lazy(() => import("./pages/AfterMoveCareDemo"));
  ...
  <Suspense fallback={<PageLoadingFallback />}>
    <AnimatedRoutes>
      ...
      <Route path="/admin/tools" element={<AdminTools />} />
          ...
          <Route path="/admin/task-queue" element={<TaskQueue />} />
    ...
    <MainLayout hideChrome={isStakeholderRoute}>
      <Suspense fallback={<PageLoadingFallback />}>
        <AnimatedRoutes>
          ...
          <Route path="/proof-engine" element={<ProofEngine />} />
          ...
          <Route path="/homepage-classic" element={<HomepageClassic />} />
          <Route path="/homepage-1" element={<HomepageV1 />} />
          ...
          {/* Legacy /regionen routes - redirect to canonical URLs */}
          <Route path="/regionen" element={<Navigate to="/umzugsfirmen-schweiz" replace />} />
          <Route path="/regionen/:slug" element={<RegionSlugRedirect />} />
          ...
          <Route path="/invisible-move-demo" element={<InvisibleMoveDashboardDemo />} />
          
          {/* After Move Care Demo */}
          <Route path="/after-move-care" element={<AfterMoveCareDemo />} />
          <Route path="/umgebungs-scan" element={<AfterMoveCareDemo />} />
          ...
          <Route path="/v10-smart-router" element={<V10SmartRouter />} />
          ...
          <Route path="/umzug-bewerten" element={<PostMoveSurveyPage />} />
