...
const partners = [
  ...
  { name: "VBZ Logistik", desc: "Transportnetzwerk", icon: Truck },
];

export const BernPartnersSection = () => (
  <section className="py-10 bg-muted/30">
    <div className="container mx-auto px-4">
      <p className="text-center text-sm text-muted-foreground mb-6">Unsere Partner in der Region Bern</p>
