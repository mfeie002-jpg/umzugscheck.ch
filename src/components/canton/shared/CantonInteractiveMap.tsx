...
interface CantonInteractiveMapProps {
  cantonName: string;
  districts: District[];
}

export const CantonInteractiveMap = ({ cantonName, districts }: CantonInteractiveMapProps) => {
  const [selectedDistrict, setSelectedDistrict] = useState<string | null>(null);

  return (
    <Card className="border-2 border-primary/10">
      <CardContent className="p-6">
        <h3 className="font-semibold text-lg mb-4">Regionen im Kanton {cantonName}</h3>
