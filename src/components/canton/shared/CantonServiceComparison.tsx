...
interface CantonServiceComparisonProps {
  cantonName: string;
...
export const CantonServiceComparison = ({ cantonName, packages = defaultPackages }: CantonServiceComparisonProps) => (
  <section className="py-12">
    <div className="container mx-auto px-4">
      <div className="text-center mb-8">
        <h2 className="text-2xl md:text-3xl font-bold mb-2">Service-Pakete vergleichen</h2>
        <p className="text-muted-foreground">Finden Sie das passende Paket für Ihren Umzug in {cantonName}</p>
      </div>
