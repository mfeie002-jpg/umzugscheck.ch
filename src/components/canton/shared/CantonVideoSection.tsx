...
interface CantonVideoSectionProps {
  cantonName: string;
  specialFeature?: string;
}

export const CantonVideoSection = ({ cantonName, specialFeature = "die lokalen Besonderheiten" }: CantonVideoSectionProps) => (
    ...
    <div className="container mx-auto px-4">
      <div className="grid md:grid-cols-2 gap-8 items-center max-w-5xl mx-auto">
        <div>
          ...
          <h2 className="text-2xl md:text-3xl font-bold mb-4">Video-Schätzung für Ihren Umzug in {cantonName}</h2>
          <p className="text-muted-foreground mb-6">
            Laden Sie ein Video Ihrer Wohnung hoch und unsere KI erstellt eine präzise Kostenschätzung – 
            ideal für Umzüge in {cantonName}, angepasst an {specialFeature}.
          </p>
        ...
        <Card className="border-2 border-dashed border-primary/30 bg-primary/5">
          <CardContent className="p-8 text-center">
            ...
            <h3 className="font-semibold mb-2">Präzise {cantonName}er Schätzung</h3>
            <p className="text-sm text-muted-foreground mb-4">
              Unsere KI kennt {specialFeature} und erstellt eine massgeschneiderte Offerte.
            </p>
