...
interface CantonWeatherWidgetProps {
  cantonName: string;
  baseTemp?: number;
}

export const CantonWeatherWidget = ({ cantonName, baseTemp = 12 }: CantonWeatherWidgetProps) => {
  ...
  const [forecast] = useState([
    { day: "Mo", temp: baseTemp + 2, condition: "sunny" },
    { day: "Di", temp: baseTemp + 1, condition: "cloudy" },
    { day: "Mi", temp: baseTemp - 1, condition: "rainy" },
    { day: "Do", temp: baseTemp, condition: "cloudy" },
    { day: "Fr", temp: baseTemp + 3, condition: "sunny" },
  ]);
    ...
    <Card className="border-2 border-primary/10">
      <CardContent className="p-6">
        <div className="flex items-center justify-between mb-4">
          <div>
            <h3 className="font-semibold text-lg">Wetter {cantonName}</h3>
