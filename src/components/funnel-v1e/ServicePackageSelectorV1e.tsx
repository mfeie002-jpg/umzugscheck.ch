/**
 * V1.e Service Package Selector
 * 
 * Same as V1.d - simplified 3-package model
 */

import { memo, useState } from "react";
import { motion, AnimatePresence } from "framer-motion";
import { Package, Sparkles, Crown, Check, Plus, ChevronUp } from "lucide-react";
...
interface ServicePackageSelectorV1eProps {
...
export const ServicePackageSelectorV1e = memo(function ServicePackageSelectorV1e({
  selectedPackage,
  selectedAddOns,
  onPackageChange,
  onAddOnToggle,
}: ServicePackageSelectorV1eProps) {
