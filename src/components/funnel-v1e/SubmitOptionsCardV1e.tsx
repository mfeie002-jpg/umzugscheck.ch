/**
 * V1.e Submit Options Card
 * 
 * Enhanced with process timeline showing what happens after submit
 */
...
interface SubmitOptionsCardV1eProps {
  value: "direct" | "publish" | "both";
...
export const SubmitOptionsCardV1e = memo(function SubmitOptionsCardV1e({
  value,
  onChange,
  selectedCompaniesCount,
  estimatedPrice,
}: SubmitOptionsCardV1eProps) {
  return (
    <div className="space-y-4">
      ...
      {/* Process Timeline - What happens after submit */}
      <ProcessTimeline />
