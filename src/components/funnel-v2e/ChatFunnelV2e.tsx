...
export function ChatFunnelV2e() {
  ...
  return (
    <div className="flex flex-col h-[calc(100dvh-6rem)] sm:h-[calc(100vh-10rem)] md:h-[600px] bg-card rounded-2xl border border-border shadow-premium overflow-hidden max-w-full overflow-x-hidden relative">
      ...
      {/* Header with Progress - Issues #2, #6, #10, #11, #16, #19, #22, #24, #27, #28, #29, #30 fixes */}
      <div className="bg-gradient-to-r from-primary/10 to-secondary/10 border-b border-border flex-shrink-0">
        {/* Progress bar - more visible with step indicator */}
        ...
        <div className="px-3 sm:px-4 py-2.5 sm:py-3 flex items-center justify-between gap-2">
          <div className="flex items-center gap-2 sm:gap-3 min-w-0">
            ...
            <div className="min-w-0">
              <h3 className="font-semibold text-sm sm:text-base">Umzugs-Assistent</h3>
              {/* Issue #6, #19, #22, #23, #24, #29 - Better progress visibility */}
          ...
          {/* Issue #2, #10, #16 - Better CTA contrast + "100% kostenlos" visible */}
          <div className="flex items-center gap-2 flex-shrink-0">
            {/* Issue #10, #11, #16 - "100% kostenlos" always visible with good contrast */}
            <Badge variant="secondary" className="bg-green-100 text-green-800 border-green-200 text-[10px] sm:text-xs font-semibold px-2 py-1 hidden xs:flex">
              <Shield className="w-3 h-3 mr-1" />
              100% gratis
            </Badge>
            <a 
              href="tel:+41445057070" 
              className="flex items-center gap-1.5 px-3 py-2 min-h-[44px] bg-green-600 hover:bg-green-700 text-white rounded-full text-xs sm:text-sm font-semibold transition-colors touch-manipulation active:scale-95 shadow-md flex-shrink-0"
            >
      ...
      {/* Footer trust elements - Issues #12, #13, #26 fix: better contrast, larger text */}
      <div className="px-3 sm:px-4 py-3 border-t border-border bg-muted/50 flex items-center justify-center gap-4 sm:gap-6 text-sm text-foreground flex-shrink-0">
        ...
        {/* Issue #10 - Mobile "100% gratis" */}
        <div className="flex items-center gap-1 xs:hidden">
          <Shield className="w-3.5 h-3.5 text-green-600" />
          <span className="font-semibold text-green-700 text-xs">Gratis</span>
        </div>
      </div>
