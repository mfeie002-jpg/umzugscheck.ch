...
// Placeholder companies for demo
const DEMO_COMPANIES: MatchedCompany[] = [
  { id: '1', name: 'Express Umzüge Zürich', rating: 4.9, reviewCount: 342, priceLevel: 'fair', distance: '2.3 km', matchScore: 98 },
...
export function GoldenFlowResultTeaser({ 
  matchedCompanies = DEMO_COMPANIES,
  onUnlock,
  className 
}: GoldenFlowResultTeaserProps) {
  const companies = matchedCompanies.length > 0 ? matchedCompanies : DEMO_COMPANIES;
            ...
            >
              ...
              <div className="flex items-center gap-3 mt-3 text-xs">
                <span className={cn(
                  ...
                  company.priceLevel === 'günstig' && "bg-green-100 text-green-700",
                  company.priceLevel === 'fair' && "bg-blue-100 text-blue-700",
                  company.priceLevel === 'premium' && "bg-purple-100 text-purple-700"
                )}>
                  {company.priceLevel}
                </span>
