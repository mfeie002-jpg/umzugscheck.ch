  ...
  return (
    ...
    >
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h3 className="font-bold text-foreground">Schnell-Kalkulator</h3>
          <p className="text-sm text-muted-foreground">Grobe Preisschätzung</p>
        </div>
      </div>
      ...
      <div className="space-y-6">
        <div>
          <div className="flex justify-between mb-2">
            <label className="text-sm font-medium text-foreground">Zimmeranzahl</label>
            <span className="text-sm font-bold text-primary">{rooms[0]} Zimmer</span>
          </div>
          <Slider
            value={rooms}
        ...
        <div>
          <div className="flex justify-between mb-2">
            <label className="text-sm font-medium text-foreground">Distanz</label>
            <span className="text-sm font-bold text-primary">{distance[0]} km</span>
          </div>
          <Slider
            value={distance}
