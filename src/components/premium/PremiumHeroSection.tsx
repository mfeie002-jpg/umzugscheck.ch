...
export const PremiumHeroSection = () => {
  ...
  return (
    <section ref={sectionRef} className={`relative ${heroHeightClass} flex items-center overflow-hidden pt-16 sm:pt-0`} style={{ position: 'relative' }}>
      ...
      {/* Content Container */}
      <div className="container mx-auto px-4 sm:px-6 py-2 sm:py-6 md:py-20 lg:py-24 relative z-10">
              ...
              <div className="space-y-3 sm:space-y-4 md:space-y-5">
                ...
                <Tabs defaultValue="form" className="w-full">
                  <TabsList className="grid w-full grid-cols-4 h-auto p-1.5 sm:p-2 bg-muted/30 rounded-xl sm:rounded-2xl gap-1.5 sm:gap-2">
                    ...
                    <TabsTrigger 
                      value="form" 
                      className="group relative flex flex-col items-center justify-center gap-1.5 py-2.5 sm:py-3 px-1.5 sm:px-2 text-[10px] sm:text-xs font-semibold rounded-lg sm:rounded-xl border-2 cursor-pointer
                    ...
                    >
                      <div className="w-7 h-7 sm:w-9 sm:h-9 rounded-lg bg-primary/10 group-data-[state=active]:bg-white/20 flex items-center justify-center transition-colors">
                        <FileText className="h-3.5 w-3.5 sm:h-5 sm:w-5 text-primary group-data-[state=active]:text-white transition-colors" />
                      </div>
                      <span>Formular</span>
                    </TabsTrigger>
                    ...
                    <TabsTrigger 
                      ...
                      className="group relative flex flex-col items-center justify-center gap-1.5 py-2.5 sm:py-3 px-1.5 sm:px-2 text-[10px] sm:text-xs font-semibold rounded-lg sm:rounded-xl border-2 cursor-pointer
                        ...
                        transition-all duration-200 active:scale-95"
                    >
                      <div className="w-7 h-7 sm:w-9 sm:h-9 rounded-lg bg-secondary/10 group-data-[state=active]:bg-white/20 flex items-center justify-center transition-colors">
                        <Video className="h-3.5 w-3.5 sm:h-5 sm:w-5 text-secondary group-data-[state=active]:text-white transition-colors" />
                      </div>
                      <span>Video</span>
                    </TabsTrigger>
                    ...
                    >
                      ...
                      <div className="w-7 h-7 sm:w-9 sm:h-9 rounded-lg bg-violet-100 group-data-[state=active]:bg-white/20 flex items-center justify-center transition-colors">
                        <Bot className="h-3.5 w-3.5 sm:h-5 sm:w-5 text-violet-600 group-data-[state=active]:text-white transition-colors" />
                      </div>
                      <span>KI-Chat</span>
                    </TabsTrigger>
                    ...
                    <TabsTrigger 
                      ...
                      className="group relative flex flex-col items-center justify-center gap-1.5 py-2.5 sm:py-3 px-1.5 sm:px-2 text-[10px] sm:text-xs font-semibold rounded-lg sm:rounded-xl border-2 cursor-pointer
                        ...
                        transition-all duration-200 active:scale-95"
                    >
                      <div className="w-7 h-7 sm:w-9 sm:h-9 rounded-lg bg-green-100 group-data-[state=active]:bg-white/20 flex items-center justify-center transition-colors">
                        <svg className="h-3.5 w-3.5 sm:h-5 sm:w-5 text-green-600 group-data-[state=active]:text-white transition-colors" viewBox="0 0 24 24" fill="currentColor">
