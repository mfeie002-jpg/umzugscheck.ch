            ...
            <div className="bg-card rounded-xl md:rounded-2xl shadow-xl border border-border p-3 sm:p-5 md:p-8 relative">
              <div className="space-y-2.5 sm:space-y-4 md:space-y-5">
                ...
                <Tabs defaultValue="form" className="w-full">
                  <TabsList className="grid w-full grid-cols-2 sm:grid-cols-4 h-auto p-1 sm:p-1.5 md:p-2 bg-muted/30 rounded-xl sm:rounded-2xl gap-1 sm:gap-1.5 md:gap-2">
                    ...
                    >
                      ...
                      <span className="font-bold whitespace-nowrap">Formular</span>
                    ...
                    >
                      ...
                      <span className="font-bold whitespace-nowrap">KI-Chat</span>
                      <span className="text-[7px] sm:text-[8px] md:text-[10px] font-normal opacity-70 group-data-[state=active]:opacity-90 leading-tight text-center hidden xs:block sm:block">
                        Persönliche Hilfe
                      </span>
                    </TabsTrigger>
                    ...
                    >
                      ...
                      <span className="font-bold whitespace-nowrap">WA</span>
                      <span className="text-[7px] sm:text-[8px] md:text-[10px] font-normal opacity-70 group-data-[state=active]:opacity-90 leading-tight text-center hidden xs:block sm:block">
                        Direkt chatten
                      </span>
                    </TabsTrigger>
