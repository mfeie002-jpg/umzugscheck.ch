...
export const PremiumHeroSection = () => {
  ...
  const heroHeightClass = screenshotMode
    ? "min-h-[640px]" // Fixed height for screenshots
    : "min-h-[70svh] sm:min-h-[70vh] md:min-h-[70vh]";

  return (
    <section
      ref={sectionRef}
      className={`relative ${heroHeightClass} flex items-start overflow-hidden pt-2 sm:pt-2`}
              ...
              <div className="space-y-2.5 sm:space-y-4 md:space-y-5">
                ...
                <Tabs defaultValue="form" className="w-full">
                  <TabsList className="grid w-full grid-cols-4 h-auto p-1.5 sm:p-2 bg-muted/30 rounded-xl gap-1 sm:gap-1.5">
                    ...
                    <TabsTrigger 
                      value="form" 
                      className="group relative flex flex-col items-center justify-center gap-0.5 sm:gap-1 py-2 sm:py-2.5 px-1 sm:px-2 rounded-lg border-2 cursor-pointer
                    ...
                    >
                      <div className="w-6 h-6 sm:w-7 sm:h-7 rounded-lg bg-primary/10 group-data-[state=active]:bg-white/20 flex items-center justify-center transition-colors">
                        <FileText className="h-3 w-3 sm:h-3.5 sm:w-3.5 text-primary group-data-[state=active]:text-white transition-colors" />
                      </div>
                      <span className="text-[10px] sm:text-xs font-bold whitespace-nowrap">Formular</span>
                    </TabsTrigger>
                    ...
                    <TabsTrigger 
                      ...
                      className="group relative flex flex-col items-center justify-center gap-0.5 sm:gap-1 py-2 sm:py-2.5 px-1 sm:px-2 rounded-lg border-2 cursor-pointer
                        ...
                        transition-all duration-200 active:scale-95"
                    >
                      <div className="w-6 h-6 sm:w-7 sm:h-7 rounded-lg bg-secondary/10 group-data-[state=active]:bg-white/20 flex items-center justify-center transition-colors">
                        <Video className="h-3 w-3 sm:h-3.5 sm:w-3.5 text-secondary group-data-[state=active]:text-white transition-colors" />
                      </div>
                      <span className="text-[10px] sm:text-xs font-bold whitespace-nowrap">Video</span>
                    </TabsTrigger>
                    ...
                    <TabsTrigger 
                      ...
                      className="group relative flex flex-col items-center justify-center gap-0.5 sm:gap-1 py-2 sm:py-2.5 px-1 sm:px-2 rounded-lg border-2 cursor-pointer
                        ...
                        transition-all duration-200 active:scale-95"
                    >
                      <span className="absolute -top-1.5 -right-0.5 px-1 py-0.5 text-[6px] sm:text-[7px] bg-violet-600 text-white rounded-full font-bold shadow-sm z-10">
                        NEU
                      </span>
                      <div className="w-6 h-6 sm:w-7 sm:h-7 rounded-lg bg-violet-100 group-data-[state=active]:bg-white/20 flex items-center justify-center transition-colors">
                        <Bot className="h-3 w-3 sm:h-3.5 sm:w-3.5 text-violet-600 group-data-[state=active]:text-white transition-colors" />
                      </div>
                      <span className="text-[10px] sm:text-xs font-bold whitespace-nowrap">KI-Chat</span>
                    </TabsTrigger>
                    ...
                    <TabsTrigger 
                      ...
                      className="group relative flex flex-col items-center justify-center gap-0.5 sm:gap-1 py-2 sm:py-2.5 px-1 sm:px-2 rounded-lg border-2 cursor-pointer
                        ...
                        transition-all duration-200 active:scale-95"
                    >
                      <div className="w-6 h-6 sm:w-7 sm:h-7 rounded-lg bg-green-100 group-data-[state=active]:bg-white/20 flex items-center justify-center transition-colors">
                        <svg className="h-3 w-3 sm:h-3.5 sm:w-3.5 text-green-600 group-data-[state=active]:text-white transition-colors" viewBox="0 0 24 24" fill="currentColor">
                      ...
                      <span className="text-[10px] sm:text-xs font-bold whitespace-nowrap">WA</span>
                    </TabsTrigger>
                  </TabsList>
