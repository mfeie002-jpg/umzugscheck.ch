  ...
  return (
    <section className="py-12 md:py-16 bg-muted/30 overflow-hidden" aria-labelledby="how-it-works-heading">
      <div className="container mx-auto px-4">
              ...
              <div key={idx} className="group relative">
                ...
                {idx < steps.length - 1 && (
                  <div className="hidden md:flex absolute -right-2 lg:-right-3 top-1/3 z-10 transform translate-x-1/2">
                    <div className="w-8 h-8 lg:w-10 lg:h-10 rounded-full bg-secondary shadow-lg flex items-center justify-center">
        ...
        {/* Social Trust Bar */}
        {isScreenshot ? (
          <div className="flex flex-wrap justify-center gap-4 sm:gap-8 md:gap-12 mb-10 py-6 px-4 bg-card/50 rounded-2xl border border-border/30">
