...
import { MapPin, ArrowRight, Shield, Star, Users, CheckCircle, ChevronDown, Sparkles, Camera } from "lucide-react";
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="max-w-4xl">
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-2 bg-gradient-to-r from-violet-600/90 to-indigo-600/90 backdrop-blur-sm text-white px-4 py-2 rounded-full mb-6 shadow-lg border border-white/20"
          >
            ...
            <span className="font-medium text-sm md:text-base">
              Schweizweit einzigartig: KI-gestützte Preisberechnung
            </span>
            <Camera className="w-4 h-4 text-white/80 hidden sm:block" />
          </motion.div>
          ...
          >
            ...
            <div className="flex items-center gap-2 bg-violet-500/20 px-3 py-1 rounded-full border border-violet-400/30">
              <Camera className="w-4 h-4 text-violet-300" />
              <span className="text-white/90 text-sm">Foto/Video Upload</span>
            </div>
          </motion.div>
