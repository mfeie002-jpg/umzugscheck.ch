...
export const SUB_VARIANT_CONFIGS: Record<string, FlowConfig> = {
  ...
  'v9d': {
    ...
    description: 'V9d Gemini-Archetyp mit 7 Steps',
    parentFlow: 'umzugsofferten-v9',
    steps: [
      { step: 1, name: 'Start', description: 'Von-Adresse eingeben' },
      { step: 2, name: 'Ziel', description: 'Nach-Adresse eingeben' },
      { step: 3, name: 'Details', description: 'Zimmer, Etage, Lift' },
      { step: 4, name: 'Analyse', description: 'Labor Illusion Animation' },
      { step: 5, name: 'Firmen', description: 'Result Teasing / Matched Companies' },
      { step: 6, name: 'Kontakt', description: 'Kontaktdaten eingeben' },
      { step: 7, name: 'Fertig', description: 'Erfolg / Bestätigung' },
    ],
  },
