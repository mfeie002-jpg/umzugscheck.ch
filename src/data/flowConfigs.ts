...
export const SUB_VARIANT_CONFIGS: Record<string, FlowConfig> = {
  ...
  'v2e': {
    ...
    path: '/umzugsofferten-v2e',
    color: 'bg-violet-500',
    description: 'V2e: Chat-basierter Funnel - Konversation statt Formular',
    parentFlow: 'umzugsofferten-v2',
    steps: [
      { step: 1, name: 'Begrüssung', description: 'Chat startet, Typ wählen' },
      { step: 2, name: 'Adressen', description: 'Von/Nach im Chat eingeben' },
      { step: 3, name: 'Details', description: 'Grösse, Datum, Services' },
      { step: 4, name: 'Preis', description: 'Preis-Reveal mit Animation' },
      { step: 5, name: 'Firmen', description: 'Firmenauswahl im Chat' },
      { step: 6, name: 'Kontakt', description: 'Absenden' },
    ],
  },
  'v2f': {
    id: 'v2f',
