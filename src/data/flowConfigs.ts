...
export const FLOW_CONFIGS: Record<string, FlowConfig> = {
  ...
  'vultimate': {
    id: 'vultimate',
    label: 'Ultimate Flow (All) ⭐',
    path: '/umzugsofferten?v=vultimate',
    color: 'bg-gradient-to-r from-indigo-500 to-purple-600',
    description: 'Ultimate Flow: Alle Varianten kombiniert',
    steps: [
      { step: 1, name: 'Adressen', description: 'Von-Nach PLZ eingeben' },
      { step: 2, name: 'Umfang', description: 'Zimmer, Stockwerk, Inventar' },
      { step: 3, name: 'Services', description: 'Datum und Zusatzleistungen' },
      { step: 4, name: 'Zusammenfassung', description: 'Übersicht und Bestätigung' },
      { step: 5, name: 'Kontakt', description: 'Kontaktdaten und Absenden' },
      { step: 6, name: 'Fertig', description: 'Erfolgsbestätigung' },
    ],
  },
  'vultimate-v1': {
    id: 'vultimate-v1',
    label: 'Ultimate Flow V1 - Swiss Archetype ⭐',
    path: '/umzugsofferten?v=vultimate-v1',
    color: 'bg-gradient-to-r from-red-500 to-orange-500',
    description: 'Ultimate Flow V1: Swiss Archetype Edition',
    steps: [
      { step: 1, name: 'Adressen', description: 'Von-Nach PLZ eingeben' },
      { step: 2, name: 'Umfang', description: 'Zimmer, Stockwerk, Inventar' },
      { step: 3, name: 'Services', description: 'Datum und Zusatzleistungen' },
  ...
  'vultimate-v2': {
    id: 'vultimate-v2',
    label: 'Ultimate Flow Vv2 ⭐',
    path: '/umzugsofferten?v=vultimate-v2',
    color: 'bg-gradient-to-r from-blue-500 to-cyan-500',
    description: 'Ultimate Flow V2: Optimierte Version',
    steps: [
      { step: 1, name: 'Adressen', description: 'Von-Nach PLZ eingeben' },
      { step: 2, name: 'Umfang', description: 'Zimmer, Stockwerk, Inventar' },
      { step: 3, name: 'Services', description: 'Datum und Zusatzleistungen' },
...
export const SUB_VARIANT_CONFIGS: Record<string, FlowConfig> = {
  ...
  'vultimate-v1': {
    id: 'vultimate-v1',
    label: 'vultimate V1 - Swiss Archetype ⭐',
    path: '/umzugsofferten?v=vultimate-v1',
    color: 'bg-gradient-to-r from-red-500 to-orange-500',
    description: 'Ultimate Flow V1: Swiss Archetype Edition',
    parentFlow: 'umzugsofferten-v9',
