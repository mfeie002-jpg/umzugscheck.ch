...
// Top 10 Flows based on analysis (placeholder ranking - will be updated by ChatGPT analysis)
const TOP_10_FLOWS = [
  {
    rank: 1,
    id: 'v9',
    ...
    reason: 'Minimale Eingaben, maximale Conversion. Optimiert für Speed und Mobile.',
  ...
  },
  {
    rank: 2,
    id: 'golden-flow-v10',
    name: 'Golden Flow V10 ⭐⭐⭐',
    description: '6 Steps, Glassmorphism, Perfekter Score.',
    reason: 'Bestes visuelles Design, Premium-Feel, High-Trust.',
  ...
  },
  {
    ...
    description: '2 Steps, 90 Sek. bis Lead.',
    reason: 'Schnellster Flow, perfekt für Mobile und Impulsentscheidungen.',
  ...
  },
  {
    ...
    description: '2 Steps, minimale Friction.',
    reason: 'ChatGPT-optimiert für höchste Conversion-Rate.',
  ...
  },
  {
    ...
    description: 'Best of 36 Varianten kombiniert.',
    reason: 'Kombination der besten Elemente aus allen Tests.',
  ...
  },
  {
    ...
    reason: 'Umfassendes Erlebnis, ideal für komplexe Umzüge.',
  ...
  {
    rank: 7,
    id: 'swiss-premium-choice',
    name: 'Swiss Premium Choice 💎',
    description: '3 Steps mit Paketauswahl.',
    reason: 'Klare Paket-Struktur, gutes Upselling-Potenzial.',
  ...
  },
  {
    ...
    reason: 'Innovativer Ansatz, differenziert sich vom Wettbewerb.',
  ...
  },
  {
    ...
    reason: 'Schnelle Erfassung, ideal für eilige Nutzer.',
  ...
  },
  {
    rank: 10,
    id: 'chatgpt-flow-2',
    name: 'ChatGPT Flow 2 - Social Proof',
    description: '3 Steps, Trust-optimiert.',
    reason: 'Starker Fokus auf Vertrauen und Bewertungen.',
