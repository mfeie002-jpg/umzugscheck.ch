/**
 * /umzugsofferten-v2b - Test Version V2.b (Simplified Labels)
 */
...
import { V2bSimplifiedLabels } from "@/components/calculator-variants";
...
const UmzugsoffertenV2b = () => {
  return (
    <div className="min-h-screen bg-background">
      <PageEnhancements />
      <Helmet>
        <title>V2.b Test | Simplified Labels | Umzugscheck.ch</title>
        <meta name="robots" content="noindex, nofollow" />
      </Helmet>

      <main id="main-content">
        <div className="container mx-auto px-4 sm:px-6 pt-3 sm:pt-4 max-w-6xl">
          <h1 className="sr-only">V2.b Test - Simplified Labels Calculator</h1>
          <Breadcrumbs items={[{ label: "V2.b Test (Simplified Labels)" }]} />
        </div>
          ...
          <div className="container mx-auto px-4 sm:px-6 max-w-6xl">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 text-sm">
              <div className="space-y-2">
                ...
                <Link to="/umzugsofferten-v2a" className="block text-primary hover:underline py-1">V2.a (Premium)</Link>
                <Link to="/umzugsofferten-v2b" className="block text-primary hover:underline py-1 font-bold">V2.b (Simplified)</Link>
              </div>
              <div className="space-y-2">
