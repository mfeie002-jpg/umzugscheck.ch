/**
 * /umzugsofferten-v3b - Test Version V3.b (Swipe Navigation)
 */
...
import { V3bSwipeNavigation } from "@/components/calculator-variants";
import { Link } from "react-router-dom";

const UmzugsoffertenV3b = () => {
  return (
    <div className="min-h-screen bg-background">
      <PageEnhancements />
      <Helmet>
        <title>V3.b Test | Swipe Navigation | Umzugscheck.ch</title>
        <meta name="robots" content="noindex, nofollow" />
      </Helmet>

      <main id="main-content">
        <div className="container mx-auto px-4 sm:px-6 pt-3 sm:pt-4 max-w-6xl">
          <h1 className="sr-only">V3.b Test - Swipe Navigation Calculator</h1>
          <Breadcrumbs items={[{ label: "V3.b Test (Swipe Navigation)" }]} />
        </div>
          ...
          <div className="container mx-auto px-4 sm:px-6 max-w-6xl">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 text-sm">
              <div className="space-y-2">
                ...
                <Link to="/umzugsofferten-v3a" className="block text-primary hover:underline py-1">V3.a (Mobile First)</Link>
                <Link to="/umzugsofferten-v3b" className="block text-primary hover:underline py-1 font-bold">V3.b (Swipe Nav)</Link>
              </div>
              <div className="space-y-2">
...
export default UmzugsoffertenV3b;
