/**
 * /umzugsofferten-v3d - Test Version V3.d (Thumb Zone)
 */
...
import { V3dThumbZone } from "@/components/calculator-variants";
import { Link } from "react-router-dom";

const UmzugsoffertenV3d = () => {
  return (
    <div className="min-h-screen bg-background">
      <PageEnhancements />
      <Helmet>
        <title>V3.d Test | Thumb Zone | Umzugscheck.ch</title>
        <meta name="robots" content="noindex, nofollow" />
      </Helmet>

      <main id="main-content">
        <div className="container mx-auto px-4 sm:px-6 pt-3 sm:pt-4 max-w-6xl">
          <h1 className="sr-only">V3.d Test - Thumb Zone Calculator</h1>
          <Breadcrumbs items={[{ label: "V3.d Test (Thumb Zone)" }]} />
        </div>
          ...
          <div className="container mx-auto px-4 sm:px-6 max-w-6xl">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 text-sm">
              <div className="space-y-2">
                ...
                <Link to="/umzugsofferten-v3d" className="block text-primary hover:underline py-1 font-bold">V3.d (Thumb Zone)</Link>
              </div>
              <div className="space-y-2">
...
export default UmzugsoffertenV3d;
