...
import { V5eReducedMotion } from "@/components/calculator-variants";
import { Link } from "react-router-dom";

const UmzugsoffertenV5e = () => {
  return (
    <div className="min-h-screen bg-background">
      <PageEnhancements />
      <Helmet>
        <title>V5.e Test | Reduced Motion | Umzugscheck.ch</title>
        <meta name="robots" content="noindex, nofollow" />
      </Helmet>

      <main id="main-content">
        <div className="container mx-auto px-4 sm:px-6 pt-3 sm:pt-4 max-w-6xl">
          <h1 className="sr-only">V5.e Test - Reduced Motion Calculator</h1>
          <Breadcrumbs items={[{ label: "V5.e Test (Reduced Motion)" }]} />
        </div>
          ...
          <div className="container mx-auto px-4 sm:px-6 max-w-6xl">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 text-sm">
              <div className="space-y-2">
                ...
                <Link to="/umzugsofferten-v5e" className="block text-primary hover:underline py-1 font-bold">V5.e (Reduced Motion)</Link>
              </div>
              <div className="space-y-2">
...
export default UmzugsoffertenV5e;
