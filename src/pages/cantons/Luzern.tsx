...
const luzernCities = ["Luzern", "Emmen", "Kriens", "Horw", "Ebikon", "Meggen", "Littau", "Root", "Adligenswil", "Rothenburg"];

const topCompanies = [
  { name: "Luzerner Umzüge AG", rating: 4.9, reviews: 287, priceLevel: "fair", sponsored: true, available: true, badge: "Top bewertet" },
  { name: "Zentralschweiz Moving", rating: 4.8, reviews: 234, priceLevel: "günstig", sponsored: true, available: true, badge: "Preistipp" },
  { name: "Pilatus Transporte", rating: 4.8, reviews: 198, priceLevel: "premium", sponsored: false, available: true, badge: "Premium" },
  { name: "Vierwaldstättersee Umzüge", rating: 4.7, reviews: 176, priceLevel: "fair", sponsored: false, available: false, badge: null },
  { name: "Emmen Express", rating: 4.7, reviews: 154, priceLevel: "günstig", sponsored: false, available: true, badge: "Beliebt" },
  { name: "Kriens Umzugsteam", rating: 4.6, reviews: 132, priceLevel: "fair", sponsored: false, available: true, badge: null },
  { name: "Tell Transporte GmbH", rating: 4.6, reviews: 118, priceLevel: "günstig", sponsored: false, available: true, badge: "Schnell" },
  { name: "Innerschweiz Moving", rating: 4.5, reviews: 98, priceLevel: "premium", sponsored: false, available: false, badge: null },
  { name: "Seetal Umzüge", rating: 4.5, reviews: 87, priceLevel: "fair", sponsored: false, available: true, badge: null },
  { name: "Reuss Transporte", rating: 4.4, reviews: 76, priceLevel: "günstig", sponsored: false, available: true, badge: "Lokal" },
];
...
const usps = [
  { title: "Zentralschweiz-Experten", desc: "Lokale Umzugsfirmen mit Regionenkenntnis", icon: Mountain },
  { title: "Bis 40% sparen", desc: "Vergleichen Sie Preise von Luzerner Firmen", icon: TrendingUp },
...
const faqs = [
  { question: "Was kostet ein Umzug in Luzern?", answer: "Ein Umzug in Luzern kostet zwischen CHF 490 und CHF 3'290 je nach Wohnungsgrösse. Die Preise in Luzern liegen leicht unter dem Schweizer Durchschnitt." },
  { question: "Gibt es Umzugsfirmen mit Alpenerfahrung?", answer: "Ja, viele Luzerner Umzugsfirmen sind auf Umzüge in bergigen Regionen spezialisiert und haben entsprechende Ausrüstung für schwierige Zugänge." },
  ...
  { question: "Kann ich auch nur einzelne Möbel transportieren lassen?", answer: "Ja, viele unserer Partner bieten auch Kleintransporte und Einzelmöbel-Transporte an." },
];
...
export const Luzern = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      <OptimizedSEO title="Umzugsfirmen Luzern – Vergleichen & bis zu 40% sparen" description="Vergleichen Sie Umzugsfirmen in Luzern. Kostenlose Offerten von geprüften Unternehmen. ✓ Zentralschweiz-Experten ✓ 100% gratis" canonicalUrl="https://umzugscheck.ch/luzern" keywords="Umzug Luzern, Umzugsfirma Luzern, Zügelfirma Luzern, Umzugsunternehmen Luzern" />
        ...
        {showNotification && (
          <motion.div initial={{ opacity: 0, x: 100 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: 100 }} className="fixed bottom-4 right-4 z-50 bg-card border border-border rounded-lg shadow-lg p-4 max-w-sm">
            <div className="flex items-start gap-3">
              ...
              <div><p className="text-sm font-medium">Neue Buchung in Emmen</p><p className="text-xs text-muted-foreground">vor 3 Minuten</p></div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
              ...
              <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4">Umzugsfirmen in <span className="text-primary">Luzern</span> vergleichen</h1>
              <p className="text-lg text-muted-foreground mb-6">Finden Sie die besten Umzugsfirmen in Luzern und der Zentralschweiz. Kostenlose Offerten von geprüften Partnern.</p>
              ...
              <div className="flex items-center gap-2 text-sm text-muted-foreground"><span className="w-2 h-2 bg-success rounded-full animate-pulse" /><span>{activeUsers} Personen vergleichen gerade in Luzern</span></div>
            </motion.div>
                ...
                <CardContent className="p-6">
                  ...
                  <div className="space-y-4">
                    <div className="grid grid-cols-2 gap-3">
                      <div><Label className="text-sm">Von</Label><select value={fromCity} onChange={e => setFromCity(e.target.value)} className="w-full mt-1 px-3 py-2 border border-border rounded-lg bg-background text-sm"><option value="">Wählen</option>{luzernCities.map(c => <option key={c} value={c}>{c}</option>)}</select></div>
                      <div><Label className="text-sm">Nach</Label><select value={toCity} onChange={e => setToCity(e.target.value)} className="w-full mt-1 px-3 py-2 border border-border rounded-lg bg-background text-sm"><option value="">Wählen</option>{luzernCities.map(c => <option key={c} value={c}>{c}</option>)}</select></div>
                    </div>
      ...
      <section className="py-12 bg-muted/30">
        <div className="container mx-auto px-4">
          <h2 className="text-2xl md:text-3xl font-bold text-center mb-8">Top 10 Umzugsfirmen in Luzern</h2>
          ...
          <div className="text-center mt-6"><Link to="/firmen?region=luzern"><Button variant="outline" size="lg">Alle Umzugsfirmen<ChevronRight className="ml-2 h-4 w-4" /></Button></Link></div>
        </div>
      </section>

      <section className="py-12"><div className="container mx-auto px-4"><h2 className="text-2xl font-bold text-center mb-8">Umzugspreise in Luzern</h2><div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">{priceExamples.map(p => <Card key={p.size} className="text-center"><CardContent className="p-6"><Home className="h-8 w-8 mx-auto mb-3 text-primary" /><h3 className="font-semibold mb-2">{p.size}</h3><p className="text-2xl font-bold text-primary">{p.avg}</p><p className="text-sm text-muted-foreground">{p.range}</p></CardContent></Card>)}</div></div></section>
      ...
      <section className="py-12 bg-muted/30"><div className="container mx-auto px-4 max-w-4xl"><h2 className="text-2xl font-bold mb-6">Umzug in Luzern – Informationen</h2><div className="prose prose-gray max-w-none text-muted-foreground"><p className="mb-4">Luzern ist das wirtschaftliche und kulturelle Zentrum der Zentralschweiz. Die Stadt am Vierwaldstättersee bietet eine hohe Lebensqualität und ist ein beliebter Wohnort.</p><h3 className="text-lg font-semibold mt-6 mb-3 text-foreground">Umzüge in der Zentralschweiz</h3><p className="mb-4">Viele Luzerner Umzugsfirmen sind auf die topografischen Besonderheiten der Region spezialisiert. Ob Seegemeinden oder Bergdörfer – die lokalen Experten kennen alle Herausforderungen.</p><h3 className="text-lg font-semibold mt-6 mb-3 text-foreground">Parkbewilligung</h3><p>Für Umzüge in Luzern empfehlen wir, eine temporäre Parkbewilligung bei der Gemeinde zu beantragen. Die Umzugsfirmen können Sie dabei unterstützen.</p></div></div></section>
      ...
      <section className="py-12 bg-primary text-primary-foreground"><div className="container mx-auto px-4 text-center"><h2 className="text-2xl font-bold mb-4">Bereit für Ihren Umzug in Luzern?</h2><p className="mb-6 opacity-90">Vergleichen Sie jetzt kostenlos die besten Umzugsfirmen</p><Link to="/umzug-offerte"><Button size="lg" variant="secondary" className="h-12 px-8">Jetzt vergleichen<ArrowRight className="ml-2 h-4 w-4" /></Button></Link></div></section>
    </div>
  );
};

export default Luzern;
