...
import { Star, Shield, Clock, TrendingUp, CheckCircle, ArrowRight, MapPin, Users, Truck, Zap, ChevronRight, Building2, Home, Package, Waves } from "lucide-react";

const schaffhausenCities = ["Schaffhausen", "Neuhausen am Rheinfall", "Beringen", "Thayngen", "Hallau", "Stein am Rhein", "Schleitheim", "Wilchingen", "Siblingen", "Trasadingen"];

const topCompanies = [
  { name: "Schaffhauser Umzüge AG", rating: 4.9, reviews: 156, priceLevel: "fair", sponsored: true, available: true, badge: "Top bewertet" },
  { name: "Rheinfall Moving", rating: 4.8, reviews: 132, priceLevel: "günstig", sponsored: true, available: true, badge: "Preistipp" },
  { name: "Neuhausen Express", rating: 4.8, reviews: 98, priceLevel: "fair", sponsored: false, available: true, badge: "Lokal" },
  { name: "Munot Transporte", rating: 4.7, reviews: 84, priceLevel: "günstig", sponsored: false, available: true, badge: null },
  { name: "Klettgau Umzüge", rating: 4.7, reviews: 72, priceLevel: "fair", sponsored: false, available: false, badge: null },
  { name: "Stein am Rhein Moving", rating: 4.6, reviews: 64, priceLevel: "premium", sponsored: false, available: true, badge: "Premium" },
  { name: "Beringen Zügeldienst", rating: 4.6, reviews: 56, priceLevel: "günstig", sponsored: false, available: true, badge: null },
  { name: "Thayngen Transporte", rating: 4.5, reviews: 48, priceLevel: "fair", sponsored: false, available: true, badge: null },
  { name: "Hallau Umzüge", rating: 4.5, reviews: 42, priceLevel: "günstig", sponsored: false, available: false, badge: null },
  { name: "Hochrhein Express", rating: 4.4, reviews: 36, priceLevel: "fair", sponsored: false, available: true, badge: null },
];

const priceExamples = [
  { size: "1-2 Zimmer", range: "CHF 400 - 750", avg: "CHF 560" },
  { size: "3-4 Zimmer", range: "CHF 850 - 1'450", avg: "CHF 1'050" },
  { size: "5+ Zimmer", range: "CHF 1'650 - 2'800", avg: "CHF 2'100" },
];
...
const usps = [
  { title: "Rheinfall-Region", desc: "Lokale Umzugsfirmen mit Regionenkenntnis", icon: Waves },
  { title: "Bis 40% sparen", desc: "Vergleichen Sie Preise lokaler Schaffhauser Firmen", icon: TrendingUp },
...
const faqs = [
  { question: "Was kostet ein Umzug in Schaffhausen?", answer: "Ein Umzug in Schaffhausen kostet zwischen CHF 400 und CHF 2'800 je nach Wohnungsgrösse. Schaffhausen gehört zu den günstigeren Kantonen." },
  { question: "Gibt es Umzugsfirmen für Umzüge nach Deutschland?", answer: "Ja, mehrere Schaffhauser Umzugsfirmen führen grenzüberschreitende Umzüge nach Deutschland durch." },
  { question: "Wie buche ich einen Umzug in Schaffhausen?", answer: "Füllen Sie unser Formular in 2 Minuten aus und erhalten Sie bis zu 5 kostenlose Offerten." },
  ...
  { question: "Bieten Sie auch Lagerung an?", answer: "Ja, viele unserer Partner bieten Einlagerungsmöglichkeiten in Schaffhausen an." },
];

const jsonLd = {
  "@context": "https://schema.org",
  "@type": "LocalBusiness",
  "name": "Umzugsfirmen Schaffhausen - Umzugscheck.ch",
  "description": "Vergleichen Sie Umzugsfirmen in Schaffhausen. Kostenlose Offerten von geprüften lokalen Unternehmen.",
  "url": "https://umzugscheck.ch/schaffhausen",
  "areaServed": { "@type": "State", "name": "Schaffhausen", "containedInPlace": { "@type": "Country", "name": "Schweiz" } },
  "serviceType": "Umzugsservice"
};

export const Schaffhausen = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      <OptimizedSEO title="Umzugsfirmen Schaffhausen – Vergleichen & bis zu 40% sparen" description="Vergleichen Sie Umzugsfirmen in Schaffhausen. Kostenlose Offerten von geprüften Unternehmen. ✓ Rheinfall-Region ✓ 100% gratis" canonicalUrl="https://umzugscheck.ch/schaffhausen" keywords="Umzug Schaffhausen, Umzugsfirma Schaffhausen, Zügelfirma Schaffhausen, Umzugsunternehmen Schaffhausen" />
        ...
        {showNotification && (
          <motion.div initial={{ opacity: 0, x: 100 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: 100 }} className="fixed bottom-4 right-4 z-50 bg-card border border-border rounded-lg shadow-lg p-4 max-w-sm">
            <div className="flex items-start gap-3">
              ...
              <div><p className="text-sm font-medium">Neue Buchung in Schaffhausen</p><p className="text-xs text-muted-foreground">vor 7 Minuten</p></div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
              <Badge className="mb-4 bg-accent/10 text-accent border-accent/30"><Waves className="h-3 w-3 mr-1" />Rheinfall-Region</Badge>
              <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4">Umzugsfirmen in <span className="text-primary">Schaffhausen</span> vergleichen</h1>
              <p className="text-lg text-muted-foreground mb-6">Finden Sie die besten Umzugsfirmen in Schaffhausen. Lokale Experten für Stadt und Region.</p>
              ...
              <div className="flex items-center gap-2 text-sm text-muted-foreground"><span className="w-2 h-2 bg-success rounded-full animate-pulse" /><span>{activeUsers} Personen vergleichen gerade in Schaffhausen</span></div>
            </motion.div>
                ...
                <CardContent className="p-6">
                  ...
                  <div className="space-y-4">
                    <div className="grid grid-cols-2 gap-3">
                      <div><Label className="text-sm">Von</Label><select value={fromCity} onChange={e => setFromCity(e.target.value)} className="w-full mt-1 px-3 py-2 border border-border rounded-lg bg-background text-sm"><option value="">Wählen</option>{schaffhausenCities.map(c => <option key={c} value={c}>{c}</option>)}</select></div>
                      <div><Label className="text-sm">Nach</Label><select value={toCity} onChange={e => setToCity(e.target.value)} className="w-full mt-1 px-3 py-2 border border-border rounded-lg bg-background text-sm"><option value="">Wählen</option>{schaffhausenCities.map(c => <option key={c} value={c}>{c}</option>)}</select></div>
                    </div>
      ...
      <section className="py-12 bg-muted/30">
        <div className="container mx-auto px-4">
          <h2 className="text-2xl md:text-3xl font-bold text-center mb-8">Top 10 Umzugsfirmen in Schaffhausen</h2>
          ...
          <div className="text-center mt-6"><Link to="/firmen?region=schaffhausen"><Button variant="outline" size="lg">Alle Umzugsfirmen<ChevronRight className="ml-2 h-4 w-4" /></Button></Link></div>
        </div>
      </section>

      <section className="py-12"><div className="container mx-auto px-4"><h2 className="text-2xl font-bold text-center mb-8">Umzugspreise in Schaffhausen</h2><div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">{priceExamples.map(p => <Card key={p.size} className="text-center"><CardContent className="p-6"><Home className="h-8 w-8 mx-auto mb-3 text-primary" /><h3 className="font-semibold mb-2">{p.size}</h3><p className="text-2xl font-bold text-primary">{p.avg}</p><p className="text-sm text-muted-foreground">{p.range}</p></CardContent></Card>)}</div></div></section>
      ...
      <section className="py-12 bg-muted/30"><div className="container mx-auto px-4 max-w-4xl"><h2 className="text-2xl font-bold mb-6">Umzug in Schaffhausen – Informationen</h2><div className="prose prose-gray max-w-none text-muted-foreground"><p className="mb-4">Schaffhausen ist der nördlichste Kanton der Schweiz und bekannt für den spektakulären Rheinfall. Die Stadt Schaffhausen mit dem Munot ist das kulturelle Zentrum.</p><h3 className="text-lg font-semibold mt-6 mb-3 text-foreground">Grenznahe Umzüge</h3><p className="mb-4">Durch die Lage an der deutschen Grenze führen viele Schaffhauser Umzugsfirmen auch internationale Umzüge nach Deutschland durch.</p></div></div></section>
      ...
      <section className="py-12 bg-primary text-primary-foreground"><div className="container mx-auto px-4 text-center"><h2 className="text-2xl font-bold mb-4">Bereit für Ihren Umzug in Schaffhausen?</h2><p className="mb-6 opacity-90">Vergleichen Sie jetzt kostenlos die besten Umzugsfirmen</p><Link to="/umzug-offerte"><Button size="lg" variant="secondary" className="h-12 px-8">Jetzt vergleichen<ArrowRight className="ml-2 h-4 w-4" /></Button></Link></div></section>
    </div>
  );
};

export default Schaffhausen;
