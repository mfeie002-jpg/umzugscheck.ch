                ...
                <div className="lg:col-span-3 space-y-4">
                  <div className="grid sm:grid-cols-2 gap-4">
                    ...
                    <KPICard
                      ...
                      subValue="Nach Ad Spend"
                      status={calculations.contributionMarginII > 1000 ? "positive" : calculations.contributionMarginII > 0 ? "warning" : "negative"}
                      icon={DollarSign}
                    />
                    <KPICard
                      label="Profit pro Lead"
                      value={formatCHF(calculations.profitPerJob)}
                      subValue={`Bei ${Math.round(calculations.bookings)} verkauften Leads/Mt.`}
                      status={calculations.profitPerJob > 10 ? "positive" : calculations.profitPerJob > 0 ? "warning" : "negative"}
                      icon={TrendingUp}
                    />
                    <KPICard
                  ...
                  <Card>
                    <CardContent className="p-4">
                      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 text-sm">
                        ...
                        <div>
                          <p className="text-muted-foreground text-xs">Verkauft</p>
