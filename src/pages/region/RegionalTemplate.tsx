            ...
            <div className="max-w-4xl mx-auto text-center text-white">
              ...
              <div className="grid grid-cols-3 gap-4 max-w-lg mx-auto mb-8">
                <div className="bg-white/10 backdrop-blur rounded-xl p-4">
                  <div className="text-2xl font-bold">{regionData.companies}+</div>
                  <div className="text-sm text-white/70">Firmen</div>
                </div>
                <div className="bg-white/10 backdrop-blur rounded-xl p-4">
                  <div className="text-2xl font-bold flex items-center justify-center gap-1">
                    {regionData.avgRating} <Star className="w-4 h-4 fill-yellow-400 text-yellow-400" />
                  </div>
                  <div className="text-sm text-white/70">Ø Bewertung</div>
                </div>
                <div className="bg-white/10 backdrop-blur rounded-xl p-4">
                  <div className="text-lg font-bold">{regionData.priceRange}</div>
                  <div className="text-sm text-white/70">Preisrange</div>
                </div>
              </div>
