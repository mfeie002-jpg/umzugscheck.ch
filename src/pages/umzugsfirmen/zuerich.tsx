                ...
                <Card className="bg-white/[0.98] backdrop-blur-xl border-0 shadow-2xl rounded-2xl overflow-hidden">
                  <CardContent className="p-6 md:p-8">
                    ...
                    <form onSubmit={handleFormSubmit} className="space-y-4 mt-4">
                      <div><Label htmlFor="from" className="text-sm font-medium flex items-center gap-1">Von (PLZ oder Ort)<TooltipProvider><Tooltip><TooltipTrigger><Info className="w-3.5 h-3.5 text-muted-foreground" /></TooltipTrigger><TooltipContent>Ihr aktueller Wohnort</TooltipContent></Tooltip></TooltipProvider></Label><Input id="from" placeholder="z.B. 8001 Zürich" value={fromLocation} onChange={(e) => setFromLocation(e.target.value)} className="mt-1.5 h-12" autoFocus /></div>
                      <div><Label htmlFor="to" className="text-sm font-medium">Nach (PLZ oder Ort)</Label><Input id="to" placeholder="z.B. 8400 Winterthur" value={toLocation} onChange={(e) => setToLocation(e.target.value)} className="mt-1.5 h-12" /></div>
