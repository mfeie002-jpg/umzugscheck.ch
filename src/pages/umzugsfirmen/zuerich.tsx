...
const QuickPriceEstimate = ({ size }: { size: string }) => {
  ...
  const estimates: Record<string, { min: number; max: number; savings: number }> = {
    ...
    "2.5-3": { min: 750, max: 1200, savings: 480 },
    "3.5-4": { min: 950, max: 1500, savings: 600 },
    "4.5-5": { min: 1300, max: 1900, savings: 640 },
...
const ZuerichLandingPage = () => {
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      setLiveViewers(prev => Math.max(35, Math.min(65, prev + Math.floor(Math.random() * 7) - 3)));
    }, 3500);
    ...
    "@graph": [
      {
        ...
        "description": "Vergleiche 80+ geprüfte Umzugsfirmen im Kanton Zürich. Kostenlose Offerten für Zürich, Winterthur, Uster & Dübendorf.",
        "areaServed": { "@type": "Place", "name": "Kanton Zürich, Schweiz" },
        "priceRange": "CHF 650 - CHF 4000",
        "aggregateRating": { "@type": "AggregateRating", "ratingValue": "4.8", "reviewCount": "4523" }
      },
      {
        "@type": "FAQPage",
  ...
  return (
    <div className="min-h-screen bg-background" data-uc-capture-root="1">
      <Helmet>
        ...
        <meta name="description" content="Vergleiche 80+ geprüfte Umzugsfirmen im Kanton Zürich ✓ Kostenlose Offerten ✓ Zürich, Winterthur, Uster & Dübendorf ✓ Bis zu 40% sparen!" />
            ...
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
              ...
              >
                ...
                <p className="text-lg md:text-xl text-white/85 mb-6 max-w-xl mx-auto lg:mx-0">
                  Vergleichen Sie <strong>80+ geprüfte Umzugsfirmen</strong> aus Zürich, Winterthur, Uster & Dübendorf.
                  ...
                  <CardContent className="p-6 md:p-8">
                    ...
                    <form onSubmit={handleFormSubmit} className="space-y-4 mt-4">
                      ...
                      <div>
                        ...
                        <Input
                          id="to"
                          placeholder="z.B. 8400 oder Winterthur"
                          value={toLocation}
          ...
          <div className="container px-4">
            <div className="flex flex-wrap items-center justify-center gap-6 md:gap-10">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs text-muted-foreground">(<AnimatedCounter end={4523} /> Bewertungen)</span>
              </div>
              ...
              <div className="flex items-center gap-2 text-sm">
                ...
                <span className="font-bold"><AnimatedCounter end={80} />+</span>
                <span className="text-muted-foreground">Firmen in Zürich</span>
              </div>
              ...
              <div className="flex items-center gap-2 text-sm">
                ...
                <span className="font-bold"><AnimatedCounter end={35000} />+</span>
        ...
        <section className="py-14 md:py-18">
          <div className="container px-4">
            ...
            >
              ...
              <p className="text-muted-foreground">Über 4'500 zufriedene Kunden im Kanton Zürich</p>
            </motion.div>
              ...
              >
                ...
                <div className="prose prose-slate max-w-none">
                  <p className="text-muted-foreground leading-relaxed mb-4">
                    Der Kanton Zürich ist der bevölkerungsreichste Kanton der Schweiz und ein beliebtes Umzugsziel. 
                    Die Stadt Zürich, <strong>Winterthur, Uster</strong> und <strong>Dübendorf</strong> bieten eine 
                    perfekte Mischung aus urbanem Leben, internationaler Atmosphäre und hoher Lebensqualität.
                  </p>
                  <p className="text-muted-foreground leading-relaxed">
                    Besonderheiten beim Umziehen in Zürich: Parkbewilligungen sind in den meisten Quartieren nötig, 
                    der Möbellift ist bei den vielen Altbauten unverzichtbar, und zur 
          ...
          <div className="container px-4 text-center relative z-10">
            ...
            >
              ...
              <p className="text-lg text-primary-foreground/85 mb-8 max-w-xl mx-auto">
                80+ geprüfte Firmen · Bis 40% sparen · 100% gratis
              </p>
