...
const SUB_VARIANT_CONFIGS: Record<string, { id: string; label: string; path: string; steps: { step: number; name: string; description: string }[] }> = {
  ...
  'v4b': { id: 'v4b', label: 'V4b - Social Proof', path: '/flow-tester?variant=v4b', steps: [{ step: 1, name: 'Trust Intro', description: 'Ratings' }, { step: 2, name: 'Umzugsdetails', description: 'PLZ, Datum' }, { step: 3, name: 'Firmenauswahl', description: 'Bewertungen' }, { step: 4, name: 'Kontakt', description: 'Absenden' }] },
