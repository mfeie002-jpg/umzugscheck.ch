...
serve(async (req) => {
  ...
  try {
    ...
    // ScreenshotMachine supports `WIDTHxfull`, but long pages can produce white stitching artifacts.
    // For the homepage we prefer a very tall single-render viewport to avoid gaps.
